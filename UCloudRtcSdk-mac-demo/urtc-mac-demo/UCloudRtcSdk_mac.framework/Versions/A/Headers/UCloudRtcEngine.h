...
/** 本地预览视频视图镜像模式 API_UNAVAILABLE(macos)*/
...
/** 视频采集旋转方向，与 UIInterfaceOrientation方向一致 API_UNAVAILABLE(macos)*/
...
@class UCloudRtcEngine,UCloudRtcStream,UCloudRtcError,UCloudRtcRoomStream,UCloudRtcStreamVolume,UCloudRtcStreamStatsInfo,UCloudRtcLog, UCloudRtcMixResponse,UCloudRtcMixConfig,UCloudRtcMixStopConfig,UCloudRtcAudioStats,UCloudRtcVideoFrame;
...
/**
 ...
 @return 0: 方法调用成功  < 0: 方法调用失败
 */
- (int)setLocalPreview:(NSView *_Nonnull)preview;
